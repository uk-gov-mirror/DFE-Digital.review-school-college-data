...
namespace Dfe.Rscd.Api.Domain.Entities
{
    public class Pupil
    {
        ...
        public bool InLatestAllocationYear =>
            Allocations != null && Allocations.Any() && Allocations.Where(a => a.Allocation != Allocation.Unknown).First().Allocation != Allocation.NotAllocated;
