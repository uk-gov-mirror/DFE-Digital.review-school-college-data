...
namespace Web09.Checking.Business.Logic.TransactionScripts
{
    ...
    {
        private static List<Prompts> GetAdjustmentPrompts_PupilNotAtEndOfKeyStage2InAllSubjects(Web09_Entities context, Students student)
        {
            ...
            if (student.PINCLs.P_INCL == "202")
            {
                ...
                promptListOut.Add(GetPromptByPromptID(Contants.PROMPT_ID_EXCEPTIONALCIRCUMSTANCES));
            }
