...
namespace Web09.Checking.Business.Logic.TransactionScripts
{
    ...
    {
        public static void DoOptin(int DFESNumber, string clientIPADdress, string userid, string username, string rolename, string firstName, string surname)
        {
            try
            {
