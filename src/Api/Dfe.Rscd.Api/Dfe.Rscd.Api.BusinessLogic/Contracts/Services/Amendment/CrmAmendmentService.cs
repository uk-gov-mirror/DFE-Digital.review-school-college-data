...
namespace Dfe.Rscd.Api.BusinessLogic.Contracts.Services
{
    public class CrmAmendmentService : IAmendmentService
    {
        ...
        public Entities.Amendments.Amendment GetAmendment(CheckingWindow checkingWindow, string id)
        {
            return GetAmendment(checkingWindow, new Guid(id));
        }

        public IEnumerable<Entities.Amendments.Amendment> GetAmendments(CheckingWindow checkingWindow, string urn)
        {
        ...
        public string AddAmendment(Entities.Amendments.Amendment amendment)
        {
        ...
        private Entities.Amendments.Amendment GetAmendment(CheckingWindow checkingWindow, Guid amendmentId)
        {
            using (var context = new CrmServiceContext(_organizationService))
            {
