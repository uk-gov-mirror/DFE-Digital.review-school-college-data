...
{
    public class RemovePupilOtherPermanentlyExcluded : Rule
    {
        ...
        public override int AmendmentReason => (int) AmendmentReasonCode.OtherPermanentlyExcludedThisSchool;
        public string ReasonDescription => "Other - Permanently excluded from this school";
    }
}